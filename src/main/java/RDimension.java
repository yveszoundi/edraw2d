 ...
 */
public class RDimension implements Cloneable, java.io.Serializable {
	 ...
	 */
	public static final RDimension SINGLETON = new RDimension();
	 ...
	 * @since 3.7
	 */
	public static RDimension max(RDimension d1, RDimension d2) {
		return new RDimension(Math.max(d1.width(), d2.width()), Math.max(
				d1.height(), d2.height()));
	}
	 ...
	 * @since 3.7
	 */
	public static RDimension min(RDimension d1, RDimension d2) {
		return new RDimension(Math.min(d1.width(), d2.width()), Math.min(
				d1.height(), d2.height()));
	}
	 ...
	 * @since 2.0
	 */
	public RDimension(RDimension d) {
		width = d.width();
		height = d.height();
	}
	 ...
	 * @since 2.0
	 */
	public boolean contains(RDimension d) {
	 ...
	 * @since 2.0
	 */
	public boolean containsProper(RDimension d) {
		return width > d.width() && height > d.height();
	}
	...
	public boolean equals(Object o) {
		if (o instanceof RDimension) {
			RDimension d = (RDimension) o;
	 ...
	 * @since 2.0
	 */
	public RDimension expand(RDimension d) {
	 ...
	 * @since 3.8
	 */
	public RDimension expand(double w, double h) {
	 ...
	 * @since 2.0
	 */
	public RDimension expand(int w, int h) {
		width += w;
		height += h;
		return this;
	}
	 ...
	 */
	public RDimension expand(RPoint p) {
	 ...
	 * @since 2.0
	 */
	public RDimension getCopy() {
		return new RDimension(this);
	}
	 ...
	 * @since 2.0
	 * @deprecated Use {@link #getShrinked(RDimension)} instead.
	 */
	public RDimension getDifference(RDimension d) {
	 ...
	 * @since 2.0
	 */
	public RDimension getExpanded(RDimension d) {
	 ...
	 * @since 3.8
	 */
	public RDimension getExpanded(double w, double h) {
	 ...
	 * @since 2.0
	 */
	public RDimension getExpanded(int w, int h) {
		return getCopy().expand(w, h);
	}
	 ...
	 * @since 2.0
	 */
	public RDimension getIntersected(RDimension d) {
	 ...
	 * @since 2.0
	 */
	public RDimension getScaled(double amount) {
	 ...
	 * @since 3.7
	 */
	public RDimension getShrinked(RDimension d) {
	 ...
	 * @since 3.8
	 */
	public RDimension getShrinked(double w, double h) {
	 ...
	 * @since 3.7
	 */
	public RDimension getShrinked(int w, int h) {
		return getCopy().shrink(w, h);
	}
	 ...
	 * @since 2.0
	 */
	public RDimension getTransposed() {
	 ...
	 * @since 2.0
	 */
	public RDimension getUnioned(RDimension d) {
	 ...
	 * @since 2.0
	 */
	public RDimension intersect(RDimension d) {
	 ...
	 * @since 2.0
	 */
	public RDimension scale(double factor) {
	 ...
	 * @since 2.0
	 */
	public RDimension scale(double widthFactor, double heightFactor) {
	 ...
	 * @since 3.7
	 */
	public RDimension setHeight(int height) {
		this.height = height;
		return this;
	}
	 ...
	 * @since 2.0
	 */
	public void setSize(RDimension d) {
	 ...
	 * @since 3.7
	 */
	public RDimension setSize(int w, int h) {
		width = w;
		height = h;
		return this;
	}
	 ...
	 * @since 3.7
	 */
	public RDimension setWidth(int width) {
		this.width = width;
		return this;
	}
	 ...
	 * @since 3.7
	 */
	public RDimension shrink(RDimension d) {
	 ...
	 * @since 3.8
	 */
	public RDimension shrink(double w, double h) {
	 ...
	 * @since 2.0
	 */
	public RDimension shrink(int w, int h) {
		width -= w;
		height -= h;
		return this;
	}
	 ...
	 * @since 2.0
	 */
	public RDimension union(RDimension d) {
