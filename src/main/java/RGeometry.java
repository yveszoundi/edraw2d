...
public class RGeometry {
	...
	/**
	 * @see RPointList#polylineContainsPoint(int, int, int)
	 * @since 3.5
	 */
	public static boolean polylineContainsPoint(RPointList points, int x, int y,
			int tolerance) {
	...
	private static boolean segmentContainsPoint(int x1, int y1, int x2, int y2,
		 ...
		 */
		RRectangle lineBounds = RRectangle.SINGLETON;
	 ...
	 * 
	 * @see RPointList#polygonContainsPoint(int, int)
	 * @since 3.5
	 */
	public static boolean polygonContainsPoint(RPointList points, int x, int y) {
		boolean isOdd = false;
		int coordinates[] = points.toIntArray();
