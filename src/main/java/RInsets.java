 ...
 */
public class RInsets implements Cloneable, java.io.Serializable {
	 ...
	 * @since 2.0
	 */
	public RInsets(int top, int left, int bottom, int right) {
		this.top = top;
		this.left = left;
		this.bottom = bottom;
		this.right = right;
	 ...
	 * @since 2.0
	 */
	public RInsets add(RInsets insets) {
		top += insets.top;
	 ...
	 * @since 2.0
	 */
	public RInsets getAdded(RInsets insets) {
		return new RInsets(this).add(insets);
	}
	 ...
	 * @since 2.0
	 */
	public RInsets getTransposed() {
		return new RInsets(this).transpose();
	}
