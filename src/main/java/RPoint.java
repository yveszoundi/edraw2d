 ...
 * Objects.
 */
public class RPoint implements Cloneable, java.io.Serializable {
	 ...
	 */
	public static final RPoint SINGLETON = new RPoint();
	 ...
	 */
	public static RPoint max(RPoint p1, RPoint p2) {
		return new RRectangle(p1, p2).getBottomRight().translate(-1, -1);
	}
	 ...
	 */
	public static RPoint min(RPoint p1, RPoint p2) {
		return new RRectangle(p1, p2).getTopLeft();
	}
	 ...
	 * @since 2.0
	 */
	public RDimension getDifference(RPoint p) {
		return new RDimension(this.x - p.x(), this.y - p.y());
	}
	 ...
	 * @since 2.0
	 */
	public double getDistance(RPoint p) {
	 ...
	 * @since 2.0
	 * @deprecated Use {@link #getDistance(RPoint)} and square the result
	 *             instead.
	 */
	public int getDistance2(RPoint p) {
		long i = p.x() - x;
		long j = p.y() - y;
		long result = i * i + j * j;
	 ...
	 */
	public int getDistanceOrthogonal(RPoint p) {
	...
	public int getPosition(RPoint p) {
		...
		if (Math.abs(dx) > Math.abs(dy)) {
			if (dx < 0)
				return RPositionConstants.WEST;
			return RPositionConstants.EAST;
		}
		if (dy < 0)
			return RPositionConstants.NORTH;
		return RPositionConstants.SOUTH;
	}
	 ...
	 * @since 2.0
	 */
	public RPoint getScaled(double factor) {
	 ...
	 * @since 3.8
	 */
	public RPoint getScaled(double xFactor, double yFactor) {
	 ...
	 * @since 2.0
	 */
	public RPoint getTranslated(RDimension d) {
	 ...
	 * @since 3.8
	 */
	public RPoint getTranslated(double x, double y) {
	 ...
	 * @since 2.0
	 */
	public RPoint getTranslated(int x, int y) {
		return getCopy().translate(x, y);
	}
	 ...
	 * @since 2.0
	 */
	public RPoint getTranslated(RPoint p) {
	 ...
	 * @since 2.0
	 */
	public RPoint scale(double factor) {
	 ...
	 * @since 2.0
	 */
	public RPoint scale(double xFactor, double yFactor) {
	 ...
	 * @since 2.0
	 */
	public RPoint setLocation(int x, int y) {
		this.x = x;
		this.y = y;
		return this;
	}
	 ...
	 * @since 2.0
	 */
	public RPoint setLocation(RPoint p) {
		x = p.x();
		y = p.y();
		return this;
	}
	 ...
	 * @since 2.0
	 */
	public RPoint translate(RDimension d) {
	 ...
	 * @since 3.8
	 */
	public RPoint translate(double x, double y) {
	 ...
	 * @since 2.0
	 */
	public RPoint translate(int dx, int dy) {
		x += dx;
		y += dy;
		return this;
	}
